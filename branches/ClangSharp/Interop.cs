...
namespace ClangSharp {
    ...
    static class Interop {
        ...
        internal struct Type {
            internal ClangSharp.TypeKind kind;
        ...
        internal static extern IntPtr clang_parseTranslationUnit(IntPtr index, string filename, string[] args,
                                                                 int numArgs, UnsavedFile[] unsavedFiles, uint numUnsavedFiles,
        ...
        [DllImport("libclang.dll", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        internal static extern Type clang_getTypedefDeclUnderlyingType(Cursor c);

        [DllImport("libclang.dll", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        internal static extern Type clang_getEnumDeclIntegerType(Cursor c);
        ...
        [DllImport("libclang.dll", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        internal static extern ClangString clang_getTypeKindSpelling(ClangSharp.TypeKind k);
