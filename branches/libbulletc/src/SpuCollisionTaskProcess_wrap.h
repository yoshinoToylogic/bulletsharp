...
extern "C"
{
	...
	//EXPORT unsigned long int SpuGatherAndProcessWorkUnitInput_getPairArrayPtr(SpuGatherAndProcessWorkUnitInput* obj);
	...
	EXPORT void SpuCollisionTaskProcess_initialize2(SpuCollisionTaskProcess* obj);
	EXPORT void SpuCollisionTaskProcess_initialize22(SpuCollisionTaskProcess* obj, bool useEpa);
