...
extern "C"
{
	...
	EXPORT void btSoftBody_sCti_setNormal(btSoftBody_sCti* obj, btScalar* value);
	...
	EXPORT void btSoftBody_sMedium_setVelocity(btSoftBody_sMedium* obj, btScalar* value);
	...
	EXPORT void btSoftBody_Node_setF(btSoftBody_Node* obj, btScalar* value);
	...
	EXPORT void btSoftBody_Node_setN(btSoftBody_Node* obj, btScalar* value);
	EXPORT void btSoftBody_Node_setQ(btSoftBody_Node* obj, btScalar* value);
	EXPORT void btSoftBody_Node_setV(btSoftBody_Node* obj, btScalar* value);
	EXPORT void btSoftBody_Node_setX(btSoftBody_Node* obj, btScalar* value);
	...
	EXPORT void btSoftBody_Link_setC3(btSoftBody_Link* obj, btScalar* value);
	...
	EXPORT void btSoftBody_Face_setNormal(btSoftBody_Face* obj, btScalar* value);
	...
	EXPORT void btSoftBody_RContact_setC0(btSoftBody_RContact* obj, btScalar* value);
	EXPORT void btSoftBody_RContact_setC1(btSoftBody_RContact* obj, btScalar* value);
	...
	EXPORT void btSoftBody_SContact_setNormal(btSoftBody_SContact* obj, btScalar* value);
	EXPORT void btSoftBody_SContact_setWeights(btSoftBody_SContact* obj, btScalar* value);
	...
	EXPORT void btSoftBody_Anchor_setC0(btSoftBody_Anchor* obj, btScalar* value);
	EXPORT void btSoftBody_Anchor_setC1(btSoftBody_Anchor* obj, btScalar* value);
	...
	EXPORT void btSoftBody_Anchor_setLocal(btSoftBody_Anchor* obj, btScalar* value);
	...
	EXPORT void btSoftBody_Note_setOffset(btSoftBody_Note* obj, btScalar* value);
	...
	EXPORT void btSoftBody_Pose_setAqq(btSoftBody_Pose* obj, btScalar* value);
	...
	EXPORT void btSoftBody_Pose_setCom(btSoftBody_Pose* obj, btScalar* value);
	//EXPORT void btSoftBody_Pose_setPos(btSoftBody_Pose* obj, btAlignedObjectArray* value);
	EXPORT void btSoftBody_Pose_setRot(btSoftBody_Pose* obj, btScalar* value);
	EXPORT void btSoftBody_Pose_setScl(btSoftBody_Pose* obj, btScalar* value);
	...
	EXPORT btAlignedNodePtrArray* btSoftBody_Cluster_getNodes(btSoftBody_Cluster* obj);
	...
	EXPORT void btSoftBody_Cluster_setAv(btSoftBody_Cluster* obj, btScalar* value);
	...
	EXPORT void btSoftBody_Cluster_setCom(btSoftBody_Cluster* obj, btScalar* value);
	...
	EXPORT void btSoftBody_Cluster_setFramexform(btSoftBody_Cluster* obj, btScalar* value);
	...
	EXPORT void btSoftBody_Cluster_setInvwi(btSoftBody_Cluster* obj, btScalar* value);
	...
	EXPORT void btSoftBody_Cluster_setLocii(btSoftBody_Cluster* obj, btScalar* value);
	EXPORT void btSoftBody_Cluster_setLv(btSoftBody_Cluster* obj, btScalar* value);
	...
	EXPORT void btSoftBody_Impulse_setDrift(btSoftBody_Impulse* obj, btScalar* value);
	EXPORT void btSoftBody_Impulse_setVelocity(btSoftBody_Impulse* obj, btScalar* value);
	...
	EXPORT void btSoftBody_Joint_setDrift(btSoftBody_Joint* obj, btScalar* value);
	EXPORT void btSoftBody_Joint_setErp(btSoftBody_Joint* obj, btScalar value);
	EXPORT void btSoftBody_Joint_setMassmatrix(btSoftBody_Joint* obj, btScalar* value);
	EXPORT void btSoftBody_Joint_setRefs(btSoftBody_Joint* obj, btScalar* value);
	EXPORT void btSoftBody_Joint_setSdrift(btSoftBody_Joint* obj, btScalar* value);
	...
	EXPORT void btSoftBody_CJoint_setNormal(btSoftBody_CJoint* obj, btScalar* value);
	...
	EXPORT btAlignedPSolverArray* btSoftBody_Config_getDsequence(btSoftBody_Config* obj);
	...
	EXPORT btAlignedPSolverArray* btSoftBody_Config_getPsequence(btSoftBody_Config* obj);
	...
	EXPORT btAlignedVSolverArray* btSoftBody_Config_getVsequence(btSoftBody_Config* obj);
	...
	EXPORT void btSoftBody_RayFromToCaster_setRayFrom(btSoftBody_RayFromToCaster* obj, btScalar* value);
	EXPORT void btSoftBody_RayFromToCaster_setRayNormalizedDirection(btSoftBody_RayFromToCaster* obj, btScalar* value);
	EXPORT void btSoftBody_RayFromToCaster_setRayTo(btSoftBody_RayFromToCaster* obj, btScalar* value);
	...
	EXPORT btAlignedAnchorArray* btSoftBody_getAnchors(btSoftBody* obj);
	...
	EXPORT btAlignedClusterArray* btSoftBody_getClusters(btSoftBody* obj);
	...
	EXPORT btAlignedJointArray* btSoftBody_getJoints(btSoftBody* obj);
	EXPORT btAlignedLinkArray* btSoftBody_getLinks(btSoftBody* obj);
	EXPORT btScalar btSoftBody_getMass(btSoftBody* obj, int node);
	EXPORT btAlignedMaterialArray* btSoftBody_getMaterials(btSoftBody* obj);
	EXPORT btDbvt* btSoftBody_getNdbvt(btSoftBody* obj);
	EXPORT btAlignedNodeArray* btSoftBody_getNodes(btSoftBody* obj);
	EXPORT btAlignedNoteArray* btSoftBody_getNotes(btSoftBody* obj);
	EXPORT btSoftBody_Pose* btSoftBody_getPose(btSoftBody* obj);
	EXPORT btAlignedRContactArray* btSoftBody_getRcontacts(btSoftBody* obj);
	...
	EXPORT btAlignedSContactArray* btSoftBody_getScontacts(btSoftBody* obj);
	...
	EXPORT btAlignedTetraArray* btSoftBody_getTetras(btSoftBody* obj);
	...
	EXPORT int btSoftBody_rayTest(btSoftBody* obj, btScalar* rayFrom, btScalar* rayTo, btScalar* mint, btSoftBody_eFeature feature, int* index, bool bcountonly);
