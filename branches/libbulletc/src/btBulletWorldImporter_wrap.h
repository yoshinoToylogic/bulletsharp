...
extern "C"
{
	...
	EXPORT bool btBulletWorldImporter_convertAllObjects(btBulletWorldImporter* obj, bParse::btBulletFile* file);
	...
	EXPORT bool btBulletWorldImporter_loadFileFromMemory2(btBulletWorldImporter* obj, bParse::btBulletFile* file);
}
