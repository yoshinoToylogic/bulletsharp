...
extern "C"
{
	...
	//EXPORT void btDbvtAabbMm_FromPoints(const btScalar* ppts, int n);
	//EXPORT void btDbvtAabbMm_FromPoints2(const btScalar* pts, int n);
	...
	EXPORT void btDbvt_sStkCLN_setNode(btDbvt_sStkCLN* obj, btDbvtNode* value);
	...
	EXPORT void btDbvt_sStkNN_setA(btDbvt_sStkNN* obj, btDbvtNode* value);
	EXPORT void btDbvt_sStkNN_setB(btDbvt_sStkNN* obj, btDbvtNode* value);
	...
	EXPORT void btDbvt_sStkNP_setNode(btDbvt_sStkNP* obj, btDbvtNode* value);
	...
	EXPORT void btDbvt_sStkNPS_setNode(btDbvt_sStkNPS* obj, btDbvtNode* value);
	...
	//EXPORT void btDbvt_collideKDOP(const btDbvtNode* root, const btScalar* normals, const btScalar* offsets, int count, const btDbvt_ICollide* policy);
	//EXPORT void btDbvt_collideOCL(const btDbvtNode* root, const btScalar* normals, const btScalar* offsets, const btScalar* sortaxis, int count, const btDbvt_ICollide* policy);
	//EXPORT void btDbvt_collideOCL2(const btDbvtNode* root, const btScalar* normals, const btScalar* offsets, const btScalar* sortaxis, int count, const btDbvt_ICollide* policy, bool fullsort);
	...
	//EXPORT void btDbvt_extractLeaves(const btDbvtNode* node, const btAlignedDbvtNodeArray* leaves);
	...
	EXPORT void btDbvt_getRayTestStack(btDbvt* obj);
	EXPORT btDbvtNode* btDbvt_getRoot(btDbvt* obj);
	EXPORT void btDbvt_getStkStack(btDbvt* obj);
