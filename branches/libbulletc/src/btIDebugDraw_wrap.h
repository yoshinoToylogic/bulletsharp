...
typedef void (STDCALL pDrawBox)(const btScalar* bbMin, const btScalar* bbMax, const btScalar* trans, const btScalar* color);
typedef void (STDCALL pDrawCapsule)(btScalar radius, btScalar halfHeight, int upAxis, const btScalar* transform, const btScalar* color);
typedef void (STDCALL pDrawContactPoint)(const btScalar* PointOnB, const btScalar* normalOnB, btScalar distance, int lifeTime, const btScalar* color);
typedef void (STDCALL pDrawCylinder)(btScalar radius, btScalar halfHeight, int upAxis, const btScalar* transform, const btScalar* color);
typedef void (STDCALL pDrawLine)(const btScalar* from, const btScalar* to, const btScalar* color);
typedef void (STDCALL pDrawPlane)(const btScalar* planeNormal, btScalar planeConst, const btScalar* transform, const btScalar* color);
typedef void (STDCALL pDrawSphere)(btScalar radius, const btScalar* transform, const btVector3& color);
typedef void (STDCALL pDrawSpherePatch)(const btScalar* center, const btScalar* up, const btScalar* axis, btScalar radius,
