...
extern "C"
{
	...
	EXPORT int btPersistentManifold_addManifoldPoint(btPersistentManifold* obj, btManifoldPoint* newPoint);
	EXPORT int btPersistentManifold_addManifoldPoint2(btPersistentManifold* obj, btManifoldPoint* newPoint, bool isPredictive);
