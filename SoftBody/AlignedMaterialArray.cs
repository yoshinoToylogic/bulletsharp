    ...
    public class AlignedMaterialArray : AlignedObjectArray, IList<Material>, IDisposable
    {
        ...
        protected virtual void Dispose(bool disposing)
        {
            if (_native != IntPtr.Zero)
            {
                if (!_preventDelete)
                {
                    btAlignedMaterialArray_delete(_native);
                }
                _native = IntPtr.Zero;
            }
        }
        ...
        public Material this[int index]
        {
            get
            {
                ...
                return new Material(btAlignedMaterialArray_at(_native, index));
            }
            set
            {
                throw new NotImplementedException();
        ...
        {
            btAlignedMaterialArray_push_back(_native, item._native);
        }

        public void Clear()
        {
            btAlignedMaterialArray_resizeNoInitialize(_native, 0);
        }
        ...
        public int Count
        {
            get { return btAlignedMaterialArray_size(_native); }
        }
        ...
        protected static extern IntPtr btAlignedMaterialArray_at(IntPtr obj, int n);
        [DllImport(Native.Dll, CallingConvention = Native.Conv), SuppressUnmanagedCodeSecurity]
        protected static extern void btAlignedMaterialArray_push_back(IntPtr obj, IntPtr val);
        [DllImport(Native.Dll, CallingConvention = Native.Conv), SuppressUnmanagedCodeSecurity]
        protected static extern void btAlignedMaterialArray_resizeNoInitialize(IntPtr obj, int newSize);
        [DllImport(Native.Dll, CallingConvention = Native.Conv), SuppressUnmanagedCodeSecurity]
        protected static extern int btAlignedMaterialArray_size(IntPtr obj);
        [DllImport(Native.Dll, CallingConvention = Native.Conv), SuppressUnmanagedCodeSecurity]
        protected static extern void btAlignedMaterialArray_delete(IntPtr obj);
    }
}
