...
extern "C"
{
	...
	EXPORT void btBox2dShape_getHalfExtentsWithMargin(btBox2dShape* obj, btScalar* extents);
	EXPORT void btBox2dShape_getHalfExtentsWithoutMargin(btBox2dShape* obj, btScalar* extents);
