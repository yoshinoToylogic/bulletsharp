...
extern "C"
{
	...
	EXPORT btScalar btTranslationalLimitMotor_solveLinearAxis(btTranslationalLimitMotor* obj, btScalar timeStep, btScalar jacDiagABInv, btRigidBody* body1, btVector3* pointInA, btRigidBody* body2, btVector3* pointInB, int limit_index, btVector3* axis_normal_on_a, btVector3* anchorPos);
	...
	EXPORT btGeneric6DofConstraint* btGeneric6DofConstraint_new(btRigidBody* rbA, btRigidBody* rbB, btTransform* frameInA, btTransform* frameInB, bool useLinearReferenceFrameA);
	EXPORT btGeneric6DofConstraint* btGeneric6DofConstraint_new2(btRigidBody* rbB, btTransform* frameInB, bool useLinearReferenceFrameB);
	EXPORT void btGeneric6DofConstraint_calcAnchorPos(btGeneric6DofConstraint* obj);
	EXPORT void btGeneric6DofConstraint_calculateTransforms(btGeneric6DofConstraint* obj, btTransform* transA, btTransform* transB);
	EXPORT void btGeneric6DofConstraint_calculateTransforms2(btGeneric6DofConstraint* obj);
	EXPORT int btGeneric6DofConstraint_get_limit_motor_info2(btGeneric6DofConstraint* obj, btRotationalLimitMotor* limot, btTransform* transA, btTransform* transB, btVector3* linVelA, btVector3* linVelB, btVector3* angVelA, btVector3* angVelB, btTypedConstraint::btConstraintInfo2* info, int row, btVector3* ax1, int rotational, int rotAllowed);
	EXPORT int btGeneric6DofConstraint_get_limit_motor_info22(btGeneric6DofConstraint* obj, btRotationalLimitMotor* limot, btTransform* transA, btTransform* transB, btVector3* linVelA, btVector3* linVelB, btVector3* angVelA, btVector3* angVelB, btTypedConstraint::btConstraintInfo2* info, int row, btVector3* ax1, int rotational);
	...
	EXPORT btTransform* btGeneric6DofConstraint_getFrameOffsetA(btGeneric6DofConstraint* obj);
	EXPORT btTransform* btGeneric6DofConstraint_getFrameOffsetB(btGeneric6DofConstraint* obj);
	...
	EXPORT void btGeneric6DofConstraint_getInfo2NonVirtual(btGeneric6DofConstraint* obj, btTypedConstraint::btConstraintInfo2* info, btTransform* transA, btTransform* transB, btVector3* linVelA, btVector3* linVelB, btVector3* angVelA, btVector3* angVelB);
	...
	EXPORT void btGeneric6DofConstraint_setAngularLowerLimit(btGeneric6DofConstraint* obj, btVector3* angularLower);
	EXPORT void btGeneric6DofConstraint_setAngularUpperLimit(btGeneric6DofConstraint* obj, btVector3* angularUpper);
	EXPORT void btGeneric6DofConstraint_setAxis(btGeneric6DofConstraint* obj, btVector3* axis1, btVector3* axis2);
	EXPORT void btGeneric6DofConstraint_setFrames(btGeneric6DofConstraint* obj, btTransform* frameA, btTransform* frameB);
	EXPORT void btGeneric6DofConstraint_setLimit(btGeneric6DofConstraint* obj, int axis, btScalar lo, btScalar hi);
	EXPORT void btGeneric6DofConstraint_setLinearLowerLimit(btGeneric6DofConstraint* obj, btVector3* linearLower);
	EXPORT void btGeneric6DofConstraint_setLinearUpperLimit(btGeneric6DofConstraint* obj, btVector3* linearUpper);
