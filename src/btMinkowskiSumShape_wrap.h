...
extern "C"
{
	...
	EXPORT void btMinkowskiSumShape_getTransformA(btMinkowskiSumShape* obj, btScalar* value);
	EXPORT void btMinkowskiSumShape_GetTransformB(btMinkowskiSumShape* obj, btScalar* value);
