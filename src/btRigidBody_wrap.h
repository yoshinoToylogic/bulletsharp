...
extern "C"
{
	...
	EXPORT const btMotionState* btRigidBody_getMotionState(btRigidBody* obj);
	...
	EXPORT void btRigidBody_setAngularFactor2(btRigidBody* obj, const btScalar* angFac);
	...
	EXPORT const btRigidBody* btRigidBody_upcast(const btCollisionObject* colObj);
