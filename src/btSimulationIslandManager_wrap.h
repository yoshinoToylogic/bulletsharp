...
extern "C"
{
	//EXPORT void btSimulationIslandManager_IslandCallback_processIsland(btSimulationIslandManager::IslandCallback* obj, * bodies, int numBodies, * manifolds, int numManifolds, int islandId);
	EXPORT void btSimulationIslandManager_IslandCallback_delete(btSimulationIslandManager::IslandCallback* obj);
	EXPORT btSimulationIslandManager* btSimulationIslandManager_new();
	EXPORT void btSimulationIslandManager_buildAndProcessIslands(btSimulationIslandManager* obj, btDispatcher* dispatcher, btCollisionWorld* collisionWorld, btSimulationIslandManager::IslandCallback* callback);
